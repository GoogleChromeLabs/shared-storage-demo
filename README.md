...
To run this demo, enable the experiment flags:

* chrome://flags/#enable-fenced-frames
* chrome://flags/#privacy-sandbox-enrollment-overrides

Then, open Google Chrome from the command line with the additional arguments as below to disable the need for attestations when running locally.

```bash
open /Applications/Google\ Chrome\ Canary.app --args --enable-privacy-sandbox-ads-apis --disable-features=EnforcePrivacySandboxAttestations
```
